  ...
  return (
    <section id="home" className="hero h-screen flex items-center justify-center text-white">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6">Building Your Dreams Into Reality</h1>
        <p className="text-xl mb-8 max-w-2xl mx-auto">
          Expert construction services delivering excellence, innovation, and quality craftsmanship for over 20 years.
        </p>
        <Link
          to="contact"
          smooth={true}
